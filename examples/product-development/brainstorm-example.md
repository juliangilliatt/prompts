...
**Template Used:** (brainstorm-template)[https://github.com/juliangilliatt/prompts/blob/main/templates/product-development/brainstorm-template]
**Context:** Example below asks for ideas on what to include in a personal website.
...
The landing page should have a very brief "about me" section, a last updated timestamp based on when I last made changes to the site, a link to my LinkedIn page, and a way to navigate to various side projects I'm working on.
The current set of side projects include:
- Shows on streaming services (e.g., Netflix) I'm watching or want to watch
- A collection of recipes I'm gathering from family members
- A prompt library that I'm iterating on and adding to
