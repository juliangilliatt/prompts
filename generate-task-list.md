Step-Wise Task Plan
<goal>
Your goal is to generate a highly detailed step-wise task plan from a complicated technical specification, leaving no detail unaddressed. You should pass back through your output several times to ensure no data is left out.
...
- Each step must not modify more than 15 files in a single run. If it does, you need to ask the user for permission and explain why it's a special case. 
...
Copy over from previous step
</technical-specification>
<project-rules>
Get rules from playbooks.com
</project-rules>
<app-details>
Copy over from previous step
</app-details>
